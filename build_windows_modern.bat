...
PUSHD build
    ...
    rem debug build
    CL /nologo /GS- /ZI /FC /EHa /Fe: %EXE_DEBUG% /DDEBUG /Tc ..\src\basalt_*.c /Tc ..\src\win32_basalt.c /Tc ..\src\assets_custom.dat.c -link -nodefaultlib -subsystem:windows user32.lib kernel32.lib gdi32.lib

    IF EXIST %EXE_DEBUG% (
        ECHO Debug build completed!

        CL /nologo /GS- /Ot /Oy /Ob2 /GF /Gy /Fe: %EXE% /Tc ..\src\basalt_*.c /Tc ..\src\win32_basalt.c /Tc ..\src\assets_custom.dat.c -link -nodefaultlib -subsystem:windows user32.lib kernel32.lib gdi32.lib
